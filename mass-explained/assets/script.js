/* ==========================================================================
   THE MASS EXPLAINED - LANDING PAGE (EN)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setCurrentDate() {
        ...
        if (dateElement) {
            ...
            console.log('Offer date set:', formattedDate);
        }
    }
    ...
    function initCarousel() {
        ...
        console.log('✅ Preview carousel initialized');
    }
    ...
    console.log(
        '%c✝️ The Mass Explained',
        'font-size: 20px; font-weight: bold; color: #722f37;'
    );
    console.log(
        '%cLanding page loaded successfully!',
        'font-size: 14px; color: #c9a227;'
    );
    console.log('Active features:');
    console.log('✅ Auto-updating current date');
    console.log('✅ Countdown timer (until end of day)');
    console.log('✅ FAQ accordion');
    console.log('✅ Preview carousel (drag/swipe)');
    console.log('✅ Smooth scroll');
    console.log('✅ CTA tracking');
    console.log('✝️ God bless!');
