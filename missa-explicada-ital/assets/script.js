/* ==========================================================================
   LA MESSA SPIEGATA - LANDING PAGE (IT)
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function setCurrentDate() {
        ...
        if (dateElement) {
            ...
            console.log('Data offerta impostata:', formattedDate);
        }
    }
    ...
    function initCarousel() {
        ...
        console.log('✅ Carosello di anteprima inizializzato');
    }
    ...
    document.querySelectorAll('a[href*="#"]').forEach(function(anchor) {
        anchor.addEventListener('click', function(e) {
            var hash = this.hash || this.getAttribute('href');
            if (!hash || hash === '#') return;

            var id = hash.indexOf('#') !== -1 ? hash.substring(hash.indexOf('#') + 1) : null;
            if (!id) return;
    ...
    console.log(
        '%c✝️ La Messa Spiegata',
        'font-size: 20px; font-weight: bold; color: #722f37;'
    );
    console.log(
        '%cLanding page caricata con successo!',
        'font-size: 14px; color: #c9a227;'
    );
    console.log('Funzionalità attive:');
    console.log('✅ Data corrente auto-aggiornata');
    console.log('✅ Conto alla rovescia (fino a fine giornata)');
    console.log('✅ FAQ a fisarmonica');
    console.log('✅ Carosello di anteprima (drag/swipe)');
    console.log('✅ Smooth scroll');
    console.log('✅ Tracciamento CTA');
    console.log('✝️ Dio vi benedica!');
