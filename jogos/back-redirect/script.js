/**
 * BACK REDIRECT - Script de Downsell - Pack 100+ Jogos para Celular
 *
 * Funcionalidades:
...
(function() {
    ...
    const CONFIG = {
        ...
        timerStorageKey: 'jogos_backredirect_timer_end',
        declineUrl: 'https://www.google.com',  // URL ao recusar a oferta
        checkoutUrl: 'https://www.ggcheckout.com/checkout/v2/cWlhHkBlofX8TQ5FyBsI'  // URL do checkout downsell
    };
    ...
    function highlightOffer() {
        ...
        offerCard.style.boxShadow = '0 15px 50px rgba(138, 43, 226, 0.5)';
    ...
    function onReady() {
        ...
        console.log('🎮 Back Redirect - Pack 100+ Jogos para Celular initialized');
    }
